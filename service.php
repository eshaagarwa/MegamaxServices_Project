...
<body>
    ...
    <div class="container-fluid position-relative p-0">
        ...
        <style>
            .custom-bg {
                background-image: url('./img/Offerings.png');
        ...
        <div class="container-fluid bg-primary py-5 bg-header custom-bg">
            ...
            <div class="row py-5 content">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Offerings</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid pb-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container pb-5">
            <div class="text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h3 class="mb-0">Tailored IT Services solutions to address your Business needs </h3>
                <h3>providing Consulting, Design, Implementation and Managed Support.</h3-->
            </div>
            <div class="row g-5">
