                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="template-demo d-grid gap-2">
                      <button type="button" class="btn btn-gradient-info btn-lg btn-block">Block buttons <i class="mdi mdi-menu float-end"></i>
                      </button>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="template-demo">
                      ...
                      <button type="button" class="btn btn-social-icon btn-outline-dribbble"><i class=" ti ti-dribbble"></i></button>
                    ...
                    <div class="template-demo">
                      ...
                      <button type="button" class="btn btn-social-icon btn-dribbble"><i class=" ti ti-dribbble"></i></button>
                    ...
                    <div class="template-demo">
                      ...
                      <button type="button" class="btn btn-social-icon btn-dribbble btn-rounded"><i class=" ti ti-dribbble"></i></button>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="template-demo">
                      ...
                      <button type="button" class="btn btn-social-icon-text btn-dribbble"><i class=" ti ti-dribbble"></i>Dribbble</button>
