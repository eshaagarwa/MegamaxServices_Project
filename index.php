...
<body>
        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <a class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>1800 257 1003</a>
                    <a class="text-light" href="//mail.google.com/mail/u/0/?view=cm&amp;fs=1&amp;tf=1&amp;source=mailto&amp;to=sales@megamaxservices.com" target="_blank"><i class="fa fa-envelope-open me-2"></i>sales@megamaxservices.com</a>
                        <!--a href="mailto:sales@megamaxservices.com">
                            <i class="fa fa-envelope" aria-hidden="true">
                            </i>sales@megamaxservices.com"
                        </a-->
                </div>
            </div>
            <div class="col-lg-4 text-center text-lg-end">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="https://www.facebook.com/megamaxservicespvtltd/"><i class="fab fa-facebook-f fw-normal"></i></a>
                    <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="https://www.linkedin.com/company/megamax-services/"><i class="fab fa-linkedin-in fw-normal"></i></a>
                    <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="https://www.instagram.com/megamaxservices/"><i class="fab fa-instagram fw-normal"></i></a>
                    <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="https://twitter.com/MegamaxServices/"><i class="fab fa-twitter fw-normal"></i></a>
                    <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle" href="https://www.youtube.com/channel/UCG2zNEVBVd8SI8J8KK5mboA"><i class="fab fa-youtube fw-normal"></i></a>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <butaton type="button" class="btn text-primary ms-3" data-bs-toggle="modal" data-bs-target="#searchModal"></button>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="service.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Learn More</a>
                            <a href="contact.php" class="btn btn-outline-light py-md-3 px-md-5 animated slideInRight">Contact
                                Us</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        <h1 class="fw-bold text-primary text-uppercase">Why Megamax?</h1>
                        <h3 class="mb-0"> Empowering Ideas, Enhancing Possibilities </h3>
                        ...
                        <div class="row">
                            ...
                            <section class="col">
                                ...
                                <div class="skills-container">
                                    ...
                                    <div class="skill">
                                        <div class="subjectr">Delivery Excellence</div>
                                        <div class="progress-barr" value="90%">
                                            <div class="progress-liner" style="max-width: 88%"></div>
                                        </div>
                                    </div>

                                    <div class="skill">
                                        <div class="subjectr">Employee Satisfaction</div>
                                        <div class="progress-barr" value="94%">
                                            <div class="progress-liner" style="max-width: 93%"></div>
                                        </div>
                                    </div>

                                    <div class="skill">
                                        <div class="subjectr">Local Office in Area of Operation
                                        </div>
                                        <div class="progress-barr" value="100%">
                                            <div class="progress-liner" style="max-width:100%"></div>
                                        </div>
                                    </div>

                                    <div class="skill">
                                        <div class="subjectr">Industry Partnerships</div>
                                        <div class="progress-barr" value="90%">
                                            <div class="progress-liner" style="max-width: 88%"></div>
                                        </div>
                                    </div>
                    ...
                    <a href="contact.php" class="btn btn-primary py-3 px-5 mt-3 wow zoomIn" data-wow-delay="0.9s">
                        Reach Us
                    </a>
                </div>
                ...
                <div class="col-lg-5" style="min-height: 400px; ">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="img/WHY MEGAMAX.jpg" style="width:200px;object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid pt-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h1 class="fw-bold text-primary text-uppercase">What To Expect ?</h1>
                <h3 class="mb-0">We Are Here to Grow Your Business Exponentially</h3>
            </div>
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="row g-5">
                        <div class="col-12 wow zoomIn" data-wow-delay="0.2s">
                            ...
                            <h4>Industry Specific in services</h4>
                ...
                <div class="col-lg-4  wow zoomIn" data-wow-delay="0.9s" style="min-height: 350px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.1s" src="img/what to expect.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="row g-5">
                        <div class="col-12 wow zoomIn" data-wow-delay="0.4s">
                            ...
                            <h4>Highly skilled, Certified</h4>
    ...
    <div class="container-fluid wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h1 class="fw-bold text-primary text-uppercase">Our Offerings</h1>
                <h3 class="mb-0">Tailored IT Services solutions to address your Business needs providing Consulting, Design, Implementation and Managed Support </h3>
            </div>
            <div class="row g-5">
    ...
    <div class="container-fluid wow fadeInUp" data-wow-delay="0.1s">
        <div class="container pt-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h1 class="fw-bold text-primary text-uppercase">Our Partners</h1>
                <h3 class="mb-0">Trusted Collaborators Driving Innovation and Success</h3>
            </div>
            <!-- Vendor Start -->
            <div class="team-img position-relative overflow-hidden">
                <img class="img-fluid w-100" src="img/Partner's Image.png" alt="">
    ...
    <div class="container-fluid wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h1 class="fw-bold text-primary text-uppercase">Systematic Product Methodology</h1>
                <h3 class="mb-0">We work systematically to achieve our target. </h3>
            </div>
    ...
    <div class="container-fluid wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h1 class="fw-bold text-primary text-uppercase">Latest Blogs</h1>
                <h3 class="mb-0">Explore our latest insights and expert opinions on industry trends, technology advancements, and best practices.</h3>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <a class="text-uppercase" href="./blog 1.html">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-4 mx-auto" style="max-width: 600px;">
                ...
                <h3 class="mb-0">What Our Clients Say About Our Digital Services</h3>
            </div>
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.6s">
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        ...
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Subbie Salami</h4>
                            <small class="text-uppercase">CEO</small>
                        </div>
                    </div>
                    <div class="pt-4 pb-5 px-5">
                        <p>Megamax Service's knowledge of the mobile application ecosystem, innovative applications, and the developer community is fantastic. They're always hands-on, and their resources are go-getters. I couldn't thank them enough for all the effort made in our successful application.</p>
                    </div>
                </div>
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                    ...
                    <div class="pt-4 pb-5 px-5">
                        <p>Megamax delivers high-quality output and meets timelines, offering innovative solutions that enhance productivity. They quickly added value and provided reliable resources. The senior leadership's hands-on approach sets a positive example for the entire team.</p>
                    </div>
                </div>
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                    ...
                    <div class="pt-4 pb-5 px-5">
                        <p>It has been quick to get through 3 years, congratulations! I've been pleased with Megamax's dependable service. Your contribution is vital to our 99.99% uptime goal, thanks to well-documented processes, trained staff, and a commitment to continuous improvement.</p>
                    </div>
                </div>
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <img class="img-fluid rounded" src="img/testimonial 4.png" style="width: 60px; height: 60px;">
                        <div class="ps-4">
                    ...
                    <div class="pt-4 pb-5 px-5">
                        <p>Megamax has been an outstanding partner for CEVA, providing managed service support for our critical systems over the past four years. Their reliability and expertise enhance our operations. We value this partnership and anticipate continued successful collaboration with Megamax.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h1 class="fw-bold text-primary text-uppercase">Latest News</h1>
                <h3 class="mb-0"> Stay up to date with the latest news and announcements from our company and the tech industry
                </h3>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="blog-item bg-light rounded overflow-hidden" style="height: 100%;">
                        ...
                        <div class="p-4">
                            ...
                            <a class="text-uppercase" href="https://www.1888pressrelease.com/megamax-services-badminton-tournament-2022-pr-709585.html">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="blog-item bg-light rounded overflow-hidden" style="height: 100%;">
                        ...
                        <div class="p-4">
                            ...
                            <a class="text-uppercase" href="https://www.ceoinsightsindia.com/leader/megamax-services-a-team-of-worldclass-mavens-catering-to-endtoend-enterprise-requirements--cid-649.html">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="blog-item bg-light rounded overflow-hidden" style="height: 100%;">
                        ...
                        <div class="p-4">
                            ...
                            <a class="text-uppercase" href="https://consultants.siliconindia.com/cover-story/megamax-services-everaging-new-innovative-technologies-to-cater-to-end-to-end-enterprise-requirements-nwid-36892.html">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <p class="mb-4">Make the right business decision by connecting with us!</p>
                ...
                <div class="col-lg-5">
                    <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn" data-wow-delay="0.9s">
                        <form method="post" action="Backend/Function.php">
                            <div class="row g-3">
                                <div class="col-xl-12">
                                    <input required type="text" name="name" class="form-control bg-light border-0" placeholder="Your Name" style="height: 55px;">
                                </div>
                                <div class="col-12">
                                    <input required type="email" name="email" class="form-control bg-light border-0" placeholder="Your Email" style="height: 55px;">
                                </div>
                                <div class="col-12">
                                    <select name="service" class="form-select bg-light border-0" style="height: 55px;">
                                        <option hidden readonly>Select A Service</option>
                                        <option value="Cyber Security">Cyber Security</option>
                                        <option value="AppOps">AppOps</option>
                                        <option value="App Modernization">App Modernization</option>
                                        <option value="Infra Managed Services">Infra Managed Services</option>
                                        <option value="Cloud">Cloud</option>
                                        <option value="DevOps">DevOps</option>
                                    </select>
                                </div>
                                <div class="col-12">
                                    <textarea required type="text" name="description" class="form-control bg-light border-0" rows="3" placeholder="Message"></textarea>
                                </div>
                                <div class="col-12">
                                    <button class="btn btn-dark w-100 py-3" type="submit" name="quote">Request A Quote</button>
                                </div>
                            </div>
                        </form>
                    </div>
